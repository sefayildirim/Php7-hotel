...
$odasor=$db->prepare("SELECT * from oda where oda_id=:oda_id");
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                  ...
                  <input type="hidden" name="oda_id" value="<?php echo $odacek['oda_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <img width="200" height="100" src="../<?php echo $odacek['oda_yol']; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="file" id="first-name"  name="oda_odayol"  class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="first-name" required="required" name="oda_baslik" value="<?php echo $odacek['oda_baslik']; ?>" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
                     <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" id="first-name" required="required" name="oda_para" value="<?php echo $odacek['oda_para']; ?>" class="form-control col-md-7 col-xs-12">
                    </div>
                  </div>
